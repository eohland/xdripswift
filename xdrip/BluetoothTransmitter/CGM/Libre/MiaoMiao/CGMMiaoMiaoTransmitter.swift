                    ...
                    case .dataPacket:
                        ...
                        if rxBuffer.count >= 363  {
                            ...
                            if let libreSensorType = LibreSensorType.type(patchInfo: patchInfo) {
                                ...
                                dataIsDecryptedToLibre1Format = libreSensorType.decryptIfPossibleAndNeeded(rxBuffer: &rxBuffer, headerLength: miaoMiaoHeaderLength, log: log, patchInfo: patchInfo, uid: [UInt8](rxBuffer.subdata(in: 5..<13)))
                ...
                case .dataPacket:
                    ...
                    if rxBuffer.count >= 363  {
                        ...
                        if let libreSensorType = LibreSensorType.type(patchInfo: patchInfo) {
                            ...
                            // decrypt of libre2 or libreUS
                            dataIsDecryptedToLibre1Format = libreSensorType.decryptIfPossibleAndNeeded(rxBuffer: &rxBuffer, headerLength: miaoMiaoHeaderLength, log: nil, patchInfo: patchInfo, uid: [UInt8](rxBuffer.subdata(in: 5..<13)))
